...
- **Saldo total** — quanto tenho agora, dividido em «disponível para gastar» e
  «guardado em metas»
- **Movimentos** — despesas e ganhos com categorias (emoji), navegação por mês
  (incluindo meses futuros, para adiantar despesas/ganhos) e filtros
...
- **Backup** — exportar/importar tudo em JSON, como rede de segurança extra
